...
MeanClass1 = mean([Data(rowC1, 2), Data(rowC1, 3), Data(rowC1, 4), Data(rowC1, 5)]);
MeanClass2 = mean([Data(rowC2, 2), Data(rowC2, 3), Data(rowC2, 4), Data(rowC2, 5)]);
MeanClass3 = mean([Data(rowC3, 2), Data(rowC3, 3), Data(rowC3, 4), Data(rowC3, 5)]);

for i = min(rowC1):max(rowC1)
    MeanClass1_LOO = mean([Data(setdiff(rowC1, i), 2), Data(setdiff(rowC1, i), 3), Data(setdiff(rowC1, i), 4), Data(setdiff(rowC1, i), 5)]);
    DataPoint = [Data(i, 2), Data(i, 3), Data(i, 4), Data(i, 5)];
...
for i = min(rowC2):max(rowC2)
    MeanClass2_LOO = mean([Data(setdiff(rowC2, i), 2), Data(setdiff(rowC2, i), 3), Data(setdiff(rowC2, i), 4), Data(setdiff(rowC2, i), 5)]);
    DataPoint = [Data(i, 2), Data(i, 3), Data(i, 4), Data(i, 5)];
...
for i = min(rowC3):max(rowC3)
    MeanClass3_LOO = mean([Data(setdiff(rowC3, i), 2), Data(setdiff(rowC3, i), 3), Data(setdiff(rowC3, i), 4), Data(setdiff(rowC3, i), 5)]);
    DataPoint = [Data(i, 2), Data(i, 3), Data(i, 4), Data(i, 5)];
