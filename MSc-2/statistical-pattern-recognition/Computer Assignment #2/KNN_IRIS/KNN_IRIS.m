...
class1 = [Data(rowC1, 2), Data(rowC1, 3), Data(rowC1, 4), Data(rowC1, 5)];
class2 = [Data(rowC2, 2), Data(rowC2, 3), Data(rowC2, 4), Data(rowC2, 5)];
class3 = [Data(rowC3, 2), Data(rowC3, 3), Data(rowC3, 4), Data(rowC3, 5)];
N1 = numel(class1(:, 1));
N2 = numel(class2(:, 1));
N3 = numel(class3(:, 1));
...
for k = 1:3
    for i = min(rowC1):max(rowC1)
        class1_LOO = [Data(setdiff(rowC1, i), 2), Data(setdiff(rowC1, i), 3), Data(setdiff(rowC1, i), 4), Data(setdiff(rowC1, i), 5)];
    ...
    for i = min(rowC2):max(rowC2)
        class2_LOO = [Data(setdiff(rowC2, i), 2), Data(setdiff(rowC2, i), 3), Data(setdiff(rowC2, i), 4), Data(setdiff(rowC2, i), 5)];
        DataPoint = [Data(i, 2), Data(i, 3), Data(i, 4), Data(i, 5)];
    ...
    for i = min(rowC3):max(rowC3)
        class3_LOO = [Data(setdiff(rowC3, i), 2), Data(setdiff(rowC3, i), 3), Data(setdiff(rowC3, i), 4), Data(setdiff(rowC3, i), 5)];
        DataPoint = [Data(i, 2), Data(i, 3), Data(i, 4), Data(i, 5)];
        for j = 1:numel(class1(:, 1))
            distance(j, 1) = euclideanDistance(DataPoint, class1(j, :));
        end
